    ...
    <div class="main-wrapper">
                ...
                <div class="sidebar-contents">
                    <div id="sidebar-menu" class="sidebar-menu">
                        ...
                        <ul>
                            ...
                            <li class="active">
                                <a href="#"><img src="assets/img/calendar.svg" alt="sidebar_img">
        ...
        <div class="page-wrapper calendar_page">
            <div class="content container-fluid">
                        ...
                        <div class="breadcrumb-path">
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="index.html"><img src="assets/img/dash.png" class="mr-2"
                ...
                <div class="customize_popup">
                    <div class="modal fade" id="add_new_event" data-backdrop="static" data-keyboard="false"
