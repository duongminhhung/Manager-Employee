...
<div class="page-wrapper">
    <div class="content container-fluid">
        <div class="page-name 	mb-4">
            <h4 class="m-0"><img src="{{ asset('assets/img/profile.jpg') }}" class="mr-1" alt="profile" /> Welcome
                Admin</h4>
            ...
            <div class="col-xl-3 col-sm-6 col-12">
                <div class="card board1 fill3 ">
                    <div class="card-body">
                        ...
                        <div class="card_widget_img">
                            <img src="{{ asset('assets/img/dash3.png') }}" alt="card-img" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 col-12">
                <div class="card board1 fill4 ">
                    <div class="card-body">
                        ...
                        <div class="card_widget_img">
                            <img src="{{ asset('assets/img/dash4.png') }}" alt="card-img" />
                        </div>
                    </div>
                </div>
            </div>
