<div class="page-wrapper">
				...
				<div class="row">
					<div class="col-xl-12 col-sm-12 col-12 ">
						<div class="breadcrumb-path mb-4">
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="index.html"><img src="{{ asset('assets/img/dash.png') }}"
										...
										<div class="row">
											...
											<div class="col-xl-6 col-sm-12 col-12 d-flex">
												<div class="member-address flex-fill">
													<label>Address</label>
													<span>Santiago de Surco <br> Av.Caminos del Inca 1325 <br> United
														States</span>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-xl-12 col-sm-12 col-12 ">
												<div class="btn-link my-3">
													<a class="btn btn-new" data-toggle="modal"
														data-target="#addcompany">Add Company Information</a>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="col-xl-12 col-sm-12 col-12 ">
												<div class="member-edits">
													<ul>
														...
														<li>
															<label><a href="/cdn-cgi/l/email-protection"
																	class="__cf_email__"
																	data-cfemail="f29a80b2949d9187818697919a9c9d9e9d958bdc919d9f">[email&#160;protected]</a></label>
															<a class="edit-link"> <i data-feather="edit"></i></a>
														</li>
													</ul>
												</div>
									...
									<table class="table  custom-table  no-footer">
										...
										<tbody>
											<tr>
												<td>
													<div class="table-img">
														<img src="{{ asset('assets/img/pdf.png') }}" alt="pdf" />
													</div>
												</td>
												<td>
												...
												<td><label><a class="action_label4" data-toggle="modal"
															data-target="#delete">Delete <i
																data-feather="trash-2"></i></a></label></td>
											</tr>
											<tr>
												<td>
													<div class="table-img">
														<img src="{{ asset('assets/img/word.png') }}" alt="profile">
													</div>
												</td>
							...
							<div class="col-xl-6 col-sm-12 col-12 d-flex">
								<div class="card card-lists flex-fill">
									<div class="card-header">
										...
										<a class="edit-link" data-toggle="modal" data-target="#editoffice"> <i
									...
									<div class="card-body d-flex align-items-center">
										<div class=" member-head employee-image">
											...
											<div class="avatar-group">
												...
												<div class="avatar avatar-xs group_img group_header">
													<img class="avatar-img rounded-circle" alt="User Image"
														src="{{ asset('assets/img/profiles/avatar-18.jpg') }}">
												</div>
											</div>
										</div>
									</div>
		...
		<div class="customize_popup">
			<div class="modal fade" id="editcompany" data-backdrop="static" data-keyboard="false" tabindex="-1"
				aria-labelledby="staticBackdropLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
		...
		<div class="customize_popup">
			<div class="modal fade" id="editoffice" tabindex="-1" aria-labelledby="staticBackdropLabels"
				aria-hidden="true">
