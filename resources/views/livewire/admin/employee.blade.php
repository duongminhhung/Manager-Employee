                ...
                <div class="row">
                        ...
                        <div class="breadcrumb-path ">
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="index.html"><img src="{{ asset('assets/img/dash.png') }}" class="mr-2"
                    ...
                    <div class="col-xl-12 col-sm-12 col-12 mb-4">
                        <div class="head-link-set">
                            ...
                            <a class="btn-add" href="{{ route('add_employee') }}"><i data-feather="plus"></i> Add Person</a>
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="table-img">
                                                        <a href="profile.html">
                                                            <img src="{{ asset('assets/img/profiles/avatar-13.jpg') }}" alt="profile"
                                                                class="img-table" />
                                                        </a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-img">
                                                        <a href="profile.html">
                                                            <img src="{{ asset('assets/img/profiles/avatar-16.jpg') }}" alt="profile"
                                                                class="img-table" />
                                                        </a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-img">
                                                        <a href="profile.html">
                                                            <img src="{{ asset('assets/img/profiles/avatar-19.jpg') }}" alt="profile"
                                                                class="img-table" />
                                                        </a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-img">
                                                        <a href="profile.html">
                                                            <img src="{{ asset('assets/img/profiles/avatar-14.jpg') }}" alt="profile"
                                                                class="img-table" />
                                                        </a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-img">
                                                        <a href="profile.html">
                                                            <img src="{{ asset('assets/img/profiles/avatar-18.jpg') }}" alt="profile"
                                                                class="img-table" />
                                                        </a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="table-img">
                                                        <a href="profile.html">
                                                            <img src="{{ asset('assets/img/profiles/avatar-10.jpg') }}" alt="profile"
                                                                class="img-table" />
                                                        </a>
